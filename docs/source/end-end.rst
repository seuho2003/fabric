...
-  Follow the steps for setting up a `development
   environment <http://hyperledger-fabric.readthedocs.io/en/latest/dev-setup/devenv/>`__
...
The `configtxgen
tool <https://github.com/hyperledger/fabric/blob/master/docs/configtxgen.md>`__
...
the value of "a"). The transaction causes the container to start.
...
-  If you see the below error:
   ...
   You likely have chaincode images (e.g. ``_peer0-peer0-mycc-1.0_`` or
   ``_peer1-peer0-mycc1-1.0_``) from prior runs. Remove them and try
   again.
